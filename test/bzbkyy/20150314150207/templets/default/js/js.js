...
$(".ddwz").each(function(hehe){

	$(this).hover(

	function(){

		$(this).stop().animate({filter: "Alpha(opacity=80)"},500).animate({height: "125px"},300);

		},function(){

		$(this).stop().animate({height: "50px"},300);
...
if(thisObj.className == "a_hover")return;
